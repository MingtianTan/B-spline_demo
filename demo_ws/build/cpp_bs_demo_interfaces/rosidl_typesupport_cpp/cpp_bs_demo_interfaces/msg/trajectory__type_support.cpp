...
static const _Trajectory_type_support_symbol_names_t _Trajectory_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_bs_demo_interfaces, msg, Trajectory)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cpp_bs_demo_interfaces, msg, Trajectory)),
  }
};
...
{
  return &::cpp_bs_demo_interfaces::msg::rosidl_typesupport_cpp::Trajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cpp_bs_demo_interfaces, msg, Trajectory)() {
  return get_message_type_support_handle<cpp_bs_demo_interfaces::msg::Trajectory>();
}
