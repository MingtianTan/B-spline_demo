...
class Bspline{
    ...
    public:
        ...
        cpp_bs_demo_interfaces::msg::Trajectory getTrajectoryMsg(const rclcpp::Time & traj_start_time) const 
        {
            cpp_bs_demo_interfaces::msg::Trajectory msg;
        
            // 填充 header 和 traj_start_time
